...
public class CourseTest {
	...
	public void setup() {
		...
		classB    = new Class(courseA, "SUMMER2014");
	...
	@Test
	public void emptyClassAveragesTest() {
		System.out.println("Average is:"+courseA.getAverageScore());
		assertTrue(classA.getAverageScore() == courseA.getAverageScore());
